...
export default connect(
    middleware(mapStateToProps, 'Component/CategorySubcategories/Container/mapStateToProps'),
    middleware(mapDispatchToProps, 'Component/CategorySubcategories/Container/mapDispatchToProps')
)(
