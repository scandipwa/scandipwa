...
export default connect(
    middleware(mapStateToProps, 'Component/ProductCard/Container/mapStateToProps'),
    middleware(mapDispatchToProps, 'Component/ProductCard/Container/mapDispatchToProps')
)(
