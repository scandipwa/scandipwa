    ...
    renderCartData(products, subTotalPrice) {
        return (
            <>
                ...
                <li block="MiniCart" elem="Subtotal" aria-label="MiniCart Subtotal">
                    <span>Save $14.00 vs Retail</span>
                    <div>
                        Subtotal:&nbsp;
                        <strong>
                            $
                ...
                <li block="MiniCart" elem="Actions" aria-label="MiniCart Actions">
                    <Link
