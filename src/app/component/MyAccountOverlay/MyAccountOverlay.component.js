    ...
    renderForgotPassword() {
        ...
        return (
            <>
                ...
                >
                    <Field type="text" id="email" name="email" label={ __('Email') } validation={ ['notEmpty', 'email'] } />
            ...
            <>
                ...
                >
                    ...
                    <fieldset block="MyAccountOverlay" elem="Legend">
                        ...
                        <Field type="text" label={ __('Email') } id="email" name="email" validation={ ['notEmpty', 'email'] } />
                        <Field
                          type="password"
                          label={ __('Password') }
                          id="password"
