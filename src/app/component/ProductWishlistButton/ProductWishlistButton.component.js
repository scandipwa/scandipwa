...
export default class ProductWishlistButton extends PureComponent {
    ...
    onClick = () => {
        ...
        if (!isInWishlist) return addToWishlist(product);
    ...
    renderPlusHeart() {
        ...
        return (
            <svg xmlns="http://www.w3.org/2000/svg" block="ProductWishlistButton" elem="PlusHeart" mods={ { isLoading } } width="28" height="28" viewBox="0 0 24 24">
    ...
    renderMinusHeart() {
        ...
        return (
            <svg xmlns="http://www.w3.org/2000/svg" block="ProductWishlistButton" elem="MinusHeart" mods={ { isLoading } } width="28" height="28" viewBox="0 0 24 24">
    ...
    renderButton() {
        const { isInWishlist, isLoading, isDisabled } = this.props;
