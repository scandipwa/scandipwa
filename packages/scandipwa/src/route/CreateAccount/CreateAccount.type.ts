...
export interface CreateAccountContainerState extends MyAccountOverlayContainerState {}

export interface CreateAccountComponentState extends MyAccountOverlayComponentState {}
