...
/** @namespace Component/ContactPage/Container/mapStateToProps */
export const mapStateToProps = (state) => ({
    isMobile: state.ConfigReducer.device.isMobile
});

/** @namespace Component/ContactPage/Container/mapDispatchToProps */
...
/** @namespace Component/ContactPage/Container */
