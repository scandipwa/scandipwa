...
export class ProductReviewsContainer<
P extends Readonly<ProductReviewsContainerProps> = Readonly<ProductReviewsContainerProps>,
S extends ProductReviewsContainerState = ProductReviewsContainerState,
