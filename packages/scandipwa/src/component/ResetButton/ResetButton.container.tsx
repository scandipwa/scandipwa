...
export class ResetButtonContainer<
P extends Readonly<ResetButtonContainerProps> = Readonly<ResetButtonContainerProps>,
S extends ResetButtonContainerState = ResetButtonContainerState,
