...
/** @namespace Component/StyleGuide/Container/mapStateToProps */
export const mapStateToProps = (state) => ({
    product: state.ProductReducer.product
});

/** @namespace Component/StyleGuide/Container/mapDispatchToProps */
export const mapDispatchToProps = (dispatch) => ({
    updateProductDetails: (product) => dispatch(updateProductDetails(product))
});

/** @namespace Component/StyleGuide/Container/StyleGuidePageContainer */
