...
function (_Extensible) {
  ...
  function _CookiePopup() {
    ...
    _defineProperty(_assertThisInitialized(_this), "state", {
      isAccepted: _util_BrowserDatabase__WEBPACK_IMPORTED_MODULE_4__["default"].getItem("".concat(_CookiePopup_config__WEBPACK_IMPORTED_MODULE_6__["COOKIE_POPUP"], "_").concat(_this.props.code)) || false
    });

    _defineProperty(_assertThisInitialized(_this), "acceptCookies", function () {
      var code = _this.props.code;
      _util_BrowserDatabase__WEBPACK_IMPORTED_MODULE_4__["default"].setItem(true, "".concat(_CookiePopup_config__WEBPACK_IMPORTED_MODULE_6__["COOKIE_POPUP"], "_").concat(code), _util_Request_QueryDispatcher__WEBPACK_IMPORTED_MODULE_5__["ONE_MONTH_IN_SECONDS"]);
...
//# sourceMappingURL=bundle.26a4eacd796fe3f35d73.hot-update.js.map