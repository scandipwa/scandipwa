...
/* harmony import */ var _util_BrowserDatabase__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../util/BrowserDatabase */ "./src/app/util/BrowserDatabase/index.js");
/* harmony import */ var _util_Request_QueryDispatcher__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../util/Request/QueryDispatcher */ "./src/app/util/Request/QueryDispatcher.js");
/* harmony import */ var _CookiePopup_config__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./CookiePopup.config */ "./src/app/component/CookiePopup/CookiePopup.config.js");
/* harmony import */ var _CookiePopup_style__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./CookiePopup.style */ "./src/app/component/CookiePopup/CookiePopup.style.scss");
/* harmony import */ var _CookiePopup_style__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_CookiePopup_style__WEBPACK_IMPORTED_MODULE_8__);
...
function (_Extensible) {
  ...
  function _CookiePopup() {
    ...
    _defineProperty(_assertThisInitialized(_this), "acceptCookies", function () {
      ...
      var param = "".concat(_CookiePopup_config__WEBPACK_IMPORTED_MODULE_7__["COOKIE_POPUP"], "_").concat(code);
      _util_BrowserDatabase__WEBPACK_IMPORTED_MODULE_5__["default"].setItem(true, param, _util_Request_QueryDispatcher__WEBPACK_IMPORTED_MODULE_6__["ONE_MONTH_IN_SECONDS"]);
  ...
  _createClass(_CookiePopup, [{
    ...
    value: function getAcceptCookieValue() {
      ...
      var param = "".concat(_CookiePopup_config__WEBPACK_IMPORTED_MODULE_7__["COOKIE_POPUP"], "_").concat(code);
      return !!_util_BrowserDatabase__WEBPACK_IMPORTED_MODULE_5__["default"].getItem(param);
    }
  }, {
    ...
    value: function render() {
      ...
      console.log(cookieScript && cookieScript !== '');

      if (cookieScript && cookieScript !== '') {
        return (
          /*#__PURE__*/
...
/***/ "./src/app/component/CookiePopup/CookiePopup.config.js":
/*!*************************************************************!*\
  !*** ./src/app/component/CookiePopup/CookiePopup.config.js ***!
  \*************************************************************/
...
/***/ "./src/app/component/CookiePopup/CookiePopup.style.scss":
/*!**************************************************************!*\
  !*** ./src/app/component/CookiePopup/CookiePopup.style.scss ***!
  \**************************************************************/
...
//# sourceMappingURL=bundle.8a891312ed4531c3f6e7.hot-update.js.map